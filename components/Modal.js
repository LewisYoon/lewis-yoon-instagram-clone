...
function Modal() {
  ...
  const uploadPost = async () => {
    ...
    // 2) get the post id for the newlt created psot
    // 3) upload the image to firebase storage with the psot id
      ...
      >
        ...
        >
          ...
          >
            ...
            px-4 pt-5 pb-4 text-left overflow-hidden
